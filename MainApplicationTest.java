...
public class MainApplicationTest
{
    ...
    { double expected = 31.0;
      ...
      double actual = mainApplication.sum(a, b);
    ...
    { double expected = 11.0;
      ...
      double actual = mainApplication.difference(a, b);
        Assert.assertEquals("Values should be equal", expected, actual, 0.0);
    ...
    { double expected = 30.0;
      ...
      double actual = mainApplication.product(a, b);
        Assert.assertEquals("Values should be equal", expected, actual, 0.0);
    ...
    { double expected = 49.0;
        double a = 7.0;
      double actual = mainApplication.square(a);
        Assert.assertEquals("Values should be equal", expected, actual, 0.0);    
    }
    ...
    { double expected = 9.0;
        double a = 81.0;
      double actual = mainApplication.squareroot(a);
        Assert.assertEquals("Values should be equal", expected, actual, 0.0);
    ...
    { double expected = 343.0;
        double a = 7.0;
        double b = 3.0;
      double actual = mainApplication.exponential(a, b);
        Assert.assertEquals("Values should be equal", expected, actual, 0.0);
    ...
    { double expected = 1/52.0;
        double a = 52.0;
      double actual = mainApplication.inverseOfNumber(a);
        Assert.assertEquals("Values should be equal", expected, actual, 0.0);
    }
    ...
    { double expected = -18.0;
        double a = 18.0;
      double actual = mainApplication.positiveOrNegative(a);
        Assert.assertEquals("Values should be equal", expected, actual, 0.0);
